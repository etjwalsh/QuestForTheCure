...
public class LoadClinical : MonoBehaviour
{
    public GameObject newSpacesTree;
    public GameObject clinicalEnvironment;
    ...
    void Start()
    {
        ...
        clinicalEnvironment.SetActive(false);
        ...
        clinicalEnvironment.SetActive(true);

        //set the level loader to have this scene's stuff in it
        LevelLoader.instance.environment = clinicalEnvironment;
    ...
    {
        //load the next scene
        LevelLoader.instance.LoadScene("Clinical");
    }
}
